...
export default function  LoginPassword({ showPassword, setShowPassword, error, onChange }: LoginPasswordProps) {
  return (
    <div className="mb-1">
      ...
      <div className="relative">
        <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
          <svg width="15" height="15" viewBox="0 0 16 16" fill="none">
            ...
            <path d="M5 7V5C5 3.34315 6.34315 2 8 2C9.65685 2 11 3.34315 11 5V7" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" />
          </svg>
        </span>
        <input
        ...
        >
          {showPassword ? (
            <svg width="15" height="15" viewBox="0 0 16 16" fill="none">
              <path d="M2 2L14 14M6.5 6.7A2 2 0 009.3 9.5M1 8s2.5-5 7-5c1.1 0 2.1.3 3 .7M15 8s-.8 1.6-2.3 2.9" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
            </svg>
          ) : (
            <svg width="15" height="15" viewBox="0 0 16 16" fill="none">
