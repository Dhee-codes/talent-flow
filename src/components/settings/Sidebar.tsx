...
export function Sidebar() {
  ...
  const active =
    "bg-[#5A8CFF] text-white shadow-[0_14px_30px_rgba(90,140,255,0.25)]";

  const inactive =
    "text-[#6B7280] hover:-translate-y-0.5 hover:bg-[#F8FAFF] hover:text-[#3E6FE6]";
  ...
  return (
    <aside className="w-full shrink-0 self-start rounded-[28px] border border-[#E9E7E2] bg-white p-6 shadow-[0_10px_30px_rgba(15,23,42,0.04)] sm:max-w-73">
      <div className="flex flex-col items-center">
        ...
        <h2 className="mb-5 text-[18px] font-bold text-[#1F2937]">
          Victor Labade
        </h2>
