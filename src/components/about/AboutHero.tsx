export function AboutHero() {
  return (
    <div 
      className="relative w-full overflow-hidden bg-cover bg-top min-h-[650px] flex items-center justify-center text-white text-center px-4"
    ...
    >
      ...
      <div className="relative z-10 max-w-[900px] mx-auto flex flex-col items-center py-36">
